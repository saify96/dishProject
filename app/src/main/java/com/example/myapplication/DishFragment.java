...
public class DishFragment extends Fragment {
     ...
     * @param dishIngredients Parameter 2.
     * @return A new instance of fragment DishFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static DishFragment newInstance(String dishName, String dishPrice, String dishIngredients) {
        DishFragment fragment = new DishFragment();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM1, dishName);
        args.putString(ARG_PARAM2, dishPrice);
        args.putString(ARG_PARAM3, dishIngredients);
